...
import './App.css';
import smokevid1 from './img/smokevid.mp4';
  ...
  return (
    <div className="App">
      <video autoPlay loop muted id='video-background'>
        <source src={smokevid1} type='video/mp4' />
      </video>
      ...
      <body>
        <div className="Menu-container">
          <Link to='/menu' className="Menu-item" id="Menu-item-menu">
          ...
          <Link to='/news' className="Menu-item" id="Menu-item-news">
          ...
          <Link to='/about' className="Menu-item" id="Menu-item-about">
          ...
          <Link to='/contact' className="Menu-item" id="Menu-item-contact">
          ...
          <Link to='/cart' className="Menu-item" id="Menu-item-cart">
